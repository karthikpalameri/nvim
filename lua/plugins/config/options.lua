...
-- more options can be found here : https://neovim.io/doc/user/options.html 
-- reference : https://github.com/unknownkoder/Java-FullStack-NeoVim-Configuration/blob/main/lua/config/options.lua
-- copied from : https://www.youtube.com/watch?v=zbpF3te0M3g&t=7580s

-- NOTE: You can change these options as you wish!
-- For more options, you can see `:help option-list`
-- Left column and similar settings
-- copied from : https://github.com/nvim-lua/kickstart.nvim/blob/master/init.lua#L504
