return {
    {
        ...
        config = function()
            ...
            -- set a vim motion to <Space> + f + h to search help_tags()
            vim.keymap.set('n', '<leader>fh', builtin.help_tags, { desc = '[F]ind help [T]ags' })
        end
    },
    {
            ...
            require("telescope").setup({
                ...
                mappings = {
                    i = {
                        ...
                        -- -- use <S> + CR Perform file vsplit on selection, usually something like
                        -- ["<S-CR>"] = actions.file_vspilt,
                    }                },
                -- load the ui-select extension
                require("telescope").load_extension("ui-select")
            })
            print("Telescope setup loaded.")
        end
    }
}
